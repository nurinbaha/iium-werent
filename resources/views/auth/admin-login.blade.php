...
<head>
    ...
    <title>IIUM WeRent - Admin Login</title>
    ...
    <div class="login-container">
        <div class="login-card">
            <div class="login-header">
                ...
                <h1>Hello, Admin ! <br>Welcome to IIUM WeRent</h1>
            ...
            <div class="divider">---- or Login as User ----</div>
            <form method="GET" action="{{ url('login') }}">
                <button type="submit" class="btn-admin">User</button>
            </form>
        </div>
    </div>
</body>
