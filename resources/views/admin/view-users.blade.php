    ...
    <div class="dashboard-container">
        ...
        <div class="main-content">
            ...
            <div class="search-box">
                ...
                <input type="text" name="name" placeholder="Search by Name" value="{{ request('name') }}" style="width: 400px; padding: 8px; border-radius: 5px; border: 1px solid #ccc;">
            ...
            <br><br>
            <!-- Display Latest Active Users -->
            <h2>Newly Active Users</h2>
            @if($latestUsers->isEmpty())
                <p>No active users found.</p>
            @else
                @foreach($latestUsers as $latestUser)
                    <div class="user-card">
                        <img src="{{ asset($latestUser->user_image ? 'storage/' . $latestUser->user_image : 'images/profiles/profile.png') }}" alt="User Photo" style="width: 180px; height: 180px; border-radius: 50%; object-fit: cover;">
                        <div class="user-info">
                            ...
                            <p>{{ $latestUser->last_active_at }}</p>
                            <p>{{ $latestUser->location }}</p>
                        </div>
                    </div>
                @endforeach
            @endif
